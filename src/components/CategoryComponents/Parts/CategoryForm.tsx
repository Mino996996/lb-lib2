...
const CategoryForm: React.FC = () => {
  ...
  return (
    <div className='mb-4'>
     ...
     <button className="ml-2 p-1 bg-green-200 rounded-lg border border-indigo-400 cursor-pointer text-lg text-gray-700 font-bold" onClick={async () => await addCategory(categoryName)}>
       登録
     </button>
    </div>
  )
