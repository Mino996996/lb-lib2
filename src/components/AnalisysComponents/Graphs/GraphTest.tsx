...
const GraphTest: React.FC = () => {
  ...
  const data1: Partial<PlotData> = threeScatterData(allEventLogs, allCategory, '赤堀さん', '2022年', colorHex(250, 86, 44));

  const data2: Partial<PlotData> = threeScatterData(allEventLogs, allCategory, '内山さん', '2022年', colorHex(100, 86, 254));
